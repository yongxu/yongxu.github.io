...
export default class Parser{
  ...
  *emitChunk(){
      if(this.chunk) {
         yield {type:'chunk', blockType:this.blockType, value:this.chunk}
         this.chunk = ''
      }
  }
  *emitLine(){
      if(this.chunk) {
         yield {type:'line', blockType:this.blockType, value:this.line}
         this.line = ''
      }
  }
  *parserGenerator(){
      ...
      switch(p.s){
        ...
        case T.TEXT:
          ...
          // }
            ...
            p.chunk += c
            yield {type:'char', blockType:p.blockType, value:c}
        ...
        case T.BLOCK_STARTED:
          ...
          yield {type:'blockStarted', blockType:p.blockType, value:null}
          p.s = T.BLOCK
          break
        case T.BLOCK_ENDING:
          yield* p.emitChunk()
          yield {type:'blockEnded', blockType:p.blockType, value:null}
          p.blockType = 'text'
          p.s = T.TEXT
      }
